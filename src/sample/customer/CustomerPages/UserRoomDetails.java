...
public class UserRoomDetails extends DBConnection implements Initializable {
    ...
    void login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("/sample/customer/Login/UserLogin.fxml",Main.stage,this.getClass(),"login", 600, 400);
    }
    @FXML
    void goToMainMenu(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("/sample/sample.fxml",Main.stage,this.getClass(),"Menu", 600, 400);
    }
